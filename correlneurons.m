...
for i = 1:109
    [r(i), p(i)] = corr(srExcSm(:,i), srExcInpSm(:,5));
end
...
for i = 1:109
    [r(i), p(i)] = corr(srExcSm(:,i), srExcInpSm(:,6));
end
...
for i = 1:109
    [r(i), p(i)] = corr(srExcSm(:,i), srExcInpSm(:,7));
end
...
for i = 1:109
    [r(i), p(i)] = corr(srExcSm(:,i), srExcInpSm(:,8));
end
...
for i = 1:109
    [r(i), p(i)] = corr(srExcSm(:,i), srExcInpSm(:,1));
end
...
for i = 1:109
    [r(i), p(i)] = corr(srExcSm(:,i), srExcInpSm(:,2));
end
...
for i = 1:109
    [r(i), p(i)] = corr(srExcSm(:,i), srExcInpSm(:,3));
end
...
for i = 1:109
    [r(i), p(i)] = corr(srExcSm(:,i), srExcInpSm(:,4));
end
...
for i = 1:109
    [r(i), p(i)] = corr(srExcSm(:,i), srExcInpSm(:,13));
end
...
for i = 1:109
    [r(i), p(i)] = corr(srExcSm(:,i), srExcInpSm(:,14));
end
...
for i = 1:109
    [r(i), p(i)] = corr(srExcSm(:,i), srExcInpSm(:,15));
end
...
for i = 1:109
    [r(i), p(i)] = corr(srExcSm(:,i), srExcInpSm(:,16));
end
...
for i = 1:109
    [r(i), p(i)] = corr(srExcSm(:,i), srExcInpSm(:,17));
end
...
%     for j = 1:4
%         [rHD(j), pHD(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,1));
%         [rHD(j), pHD(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,2));
%         [rHD(j), pHD(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,3));
%         [rHD(j), pHD(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,4));
%     end
%     rAll(1) = min(pHD);
%     for j = 1:4
%         [rAV(j), pAV(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,1));
%         [rAV(j), pAV(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,2));
%         [rAV(j), pAV(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,3));
%         [rAV(j), pAV(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,4));
%     end
%     rAll(2) = min(pAV);
%     for j = 1:5
%         [rLV(j), pLV(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,1));
%         [rLV(j), pLV(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,2));
%         [rLV(j), pLV(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,3));
%         [rLV(j), pLV(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,4));
%         [rLV(j), pLV(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,5));
%     end
%     rAll(3) = min(pLV);
%     for j = 1:3
%         [rPos(j), pPos(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,1));
%         [rPos(j), pPos(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,2));
%         [rPos(j), pPos(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,3));
%     end
%     rAll(4) = min(pPos);
%     for j = 1:3
%         [rProg(j), pProg(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,1));
%         [rProg(j), pProg(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,2));
%         [rProg(j), pProg(j)] = corr(srExcSm(:,belongs4(i)), srExcInpSm(:,3));
%     end 
%     rAll(5) = min(pProg);
% %     rAll(:)
% %     min(rAll)
